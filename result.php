...
<head>
    ...
    <title>Search Result for <?php if(isset($_GET['search-location'])&&!empty($_GET['search-location'])){echo $_GET['search-location'];}elseif(isset($_GET['rent_range'])){echo $_GET['rent_range'];}else{echo $_GET['q'];} ?></title>
</head>
<body>
    ...
    <section class="result_page">
        <?php if(isset($_GET['search-location'])||isset($_GET['rent_range'])||isset($_GET['q'])||isset($_GET['p'])){displayResult();} ?>
    </section> 
    <section class="pagination">
        <?php if(isset($_GET['search-location'])||isset($_GET['rent_range'])||isset($_GET['q'])||isset($_GET['p'])){displayPagination();} ?>
    </section>
    <script>
