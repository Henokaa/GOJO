...
if (document.getElementById("accept_btn")) {
    document.getElementById("accept_btn").addEventListener("click", (e) => {
        const request = new XMLHttpRequest();
        request.onload = function() {
            console.log(this.responseText);
        }
        request.open("GET", "includes/functions.php?cookie=lklk", true);
        request.send();
        $("#cookie").fadeOut(1000);
    });
}
if (document.getElementById("reject_btn")) {
    document.getElementById("reject_btn").addEventListener("click", (e) => {
        const request = new XMLHttpRequest();
        request.onload = function() {
            console.log(this.responseText);
        }
        request.open("GET", "includes/functions.php?cookie=jkhj", true);
        request.send();
        $("#cookie").fadeOut(1000);
    });
}
if (document.getElementById("search_form")) {
    document.getElementById("search_form").addEventListener('submit', (e) => {
        ...
        if (document.getElementById("search-location").value || document.getElementById("range-select").value) {
            const request = new XMLHttpRequest();
            request.open("GET", "includes/functions.php?cookie=" + document.getElementById("search-location").value ? document.getElementById("search-location").value : document.getElementById("range-select").value, true);
            request.send();
...
$(".menu li a[href^='#']").click(function(e) {
    ...
    if (document.querySelector(".overlay").style.display == "block") {
        ...
        if (document.querySelector(".header .header-menu") && document.body.clientWidth > 688) {
...
if (document.querySelector(".burger_icon")) {
    document.querySelector(".burger_icon").addEventListener('click', () => {
        ...
        document.querySelector(".menu .header-menu").style.background = "black";
    });
    if (document.querySelector(".sticky .burger_icon")) {
        document.querySelector(".sticky .burger_icon").addEventListener('click', () => {
            document.querySelector(".overlay").style.display = "block";
            document.querySelector(".menu .header-menu").style.transform = "translate3d(0,0,0)";
        });
    }
...
document.querySelector(".overlay").addEventListener('click', (e) => {
    ...
    document.querySelector(".menu .header-menu").style.background = null;
...
window.addEventListener('resize', e => {
    if (document.body.clientWidth > 688) {
        ...
        document.querySelector(".menu .header-menu").style.transform = null;
    }
});
...
if (document.getElementById("suggestion_form")) {
    document.getElementById("suggestion_form").addEventListener("submit", (e) => {
        e.preventDefault();
        if (document.getElementById("name").value != "" && document.getElementById("suggest_email").value != "" && document.getElementById("text_area").value != "") {
...
if (document.getElementById("beds")) {
    document.getElementById("beds").addEventListener("change", e => {
        if (document.getElementById("beds").value <= 0) {
            document.getElementById("bedCheck").textContent = "Number of beds can't be negative or Zero";
            document.getElementById("bedCheck").style.outlineColor = "rgb(211, 22, 22)";
        } else {
            document.getElementById("bedCheck").textContent = "";
        }
    })
}
if (document.getElementById("rentNum")) {
    document.getElementById("rentNum").addEventListener("change", e => {
        if (document.getElementById("rentNum").value <= 0) {
            document.getElementById("rentCheck").textContent = "rent price can't be negative or Zero";
            document.getElementById("rentCheck").style.outlineColor = "rgb(211, 22, 22)";
        } else {
